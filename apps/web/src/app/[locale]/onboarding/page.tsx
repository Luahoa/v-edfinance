  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 p-6 text-center dark:bg-black">
      <div className="w-full max-w-lg rounded-xl bg-white p-8 shadow-lg dark:bg-zinc-900">
        ...
        <p className="mt-4 text-zinc-600 dark:text-zinc-400">{t('description')}</p>
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <button
                  onClick={nextStep}
                  data-testid="onboarding-beginner"
                  className="rounded-lg border p-3 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                >
                  {t('beginner')}
                </button>
                <button
          ...
          {step === 2 && (
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2">
                <button
                  onClick={nextStep}
                  data-testid="onboarding-longterm"
                  className="rounded-lg border p-3 hover:bg-zinc-50 dark:hover:bg-zinc-800"
                >
                  {t('longTerm')}
                </button>
