                        ...
                        <div className="flex-1 overflow-y-auto p-2 space-y-1">
                            {threads.map((thread) => (
                                <button
                                    ...
                                    className={`w-full rounded-lg p-3 text-left text-sm transition-colors focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:outline-none ${currentThread?.id === thread.id
                        ...
                        {!currentThread ? (
                            ...
                            messages.map((m) => (
                                <div key={m.id} className={`flex ${m.role === 'USER' ? 'justify-end' : 'justify-start'}`}>
                                    <div className={`flex max-w-[85%] gap-2 rounded-2xl p-4 ${m.role === 'USER'
